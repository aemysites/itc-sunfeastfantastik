...
## Environments
- Preview: https://main--itc-sunfeastfantastik--aemysites.aem.page/
- Live: https://main--itc-sunfeastfantastik--aemysites.aem.live/
- Block Library: https://main--itc-sunfeastfantastik--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-sunfeastfantastik` directory in your favorite IDE and start coding :)
